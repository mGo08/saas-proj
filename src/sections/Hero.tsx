...
export const Hero = () => {
    ...
    return (
        <section
            ref={heroRef} className='pt-8 pb-20 md:pt-5 md-pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip'>
            <div className="container">
                <div className='md:flex items-center'>
                    <div className='md:w-[478px]'>
                        <div
                            className="tag">Version 2.0 is here</div>
                    ...
                    <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative'>
                        ...
                        width={220} 
                        alt='Noodle image'
                        className='hidden lg:block absolute top-[545px] left-[448px] rotate-[30deg]'
                        style={{
                            rotate: 30,
                            translateY: translateY,
                        }} 
